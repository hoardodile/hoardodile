...
export function serverErrorMessage(
	...
	return shellCatalogFor(language).desktopShell.errorPage.serverError
}
...
export function devServerErrorMessage(
	...
	return shellCatalogFor(language).desktopShell.errorPage.devServerError
}
...
export function rendererCrashedMessage(
	...
	return shellCatalogFor(language).desktopShell.errorPage.rendererCrashed
}
