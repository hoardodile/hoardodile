...
import { useIsMobile } from "@hoardodile/ui/hooks/use-mobile"
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{t("aria.sidebar")}</SheetTitle>
            <SheetDescription>{t("aria.mobileSidebarDescription")}</SheetDescription>
          </SheetHeader>
