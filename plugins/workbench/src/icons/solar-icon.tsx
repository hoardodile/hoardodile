...
/**
 * Lazy Solar glyph renderer for the workbench's simulated card template
 * icons.
 *
 ...
 * throws. Verbatim copy of the app's `apps/web/.../icons/solar-icon.tsx`
